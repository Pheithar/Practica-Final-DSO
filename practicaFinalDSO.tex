...
\begin{document}
  ...
  \begin{figure}[H]
    \centering
    \imgcenter{Images/EntradaSalida.png}
    \caption{Arquitectura del sistema de E/S}\cite{E/S}
  \end{figure}
  ...
  \begin{figure}[H]
    \centering
    \imgcenter[110]{Images/modulosDriver.png}
  ...
  \begin{figure}[H]
    \centering
    \imgcenter[150]{Images/unixFichero.png}
  ...
  \begin{figure}[H]
    \centering
    \imgcenter[130]{Images/fatFichero.png}
