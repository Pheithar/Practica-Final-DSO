...
\begin{document}
  ...
  \begin{figure}[H]
    \centering
    \imgcenter[100]{Images/States.png}
    \caption{Diagrama de Estados de los Procesos}\cite{states}
  \end{figure}
  ...
  El \textbf{CCI}(\textit{Cambio de Contexto Involuntario})
  ...
  \begin{thebibliography}{9}
    ...
    \bibitem{states}
    studytonight, Operating System Processes. Recuperado el 25 de mayo de 2020, de \url{https://www.studytonight.com/operating-system/operating-system-processes}
